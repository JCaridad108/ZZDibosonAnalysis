Job = {
    ...
    "Fraction"        : 0.01,  # set to 1.0 to analyze the full statistics
...
prefix2 = "/Volumes/OpenData11/data/2lep/" # replace with local data directory
prefix4 = "/Volumes/OpenData11/data/4lep/" # replace with local data directory
